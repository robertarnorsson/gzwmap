...
const IWentISawIConquered_Objective1: objective = {
    name: "Ridge",
    description: "Survey the sawmill from the nearby ridge",
    position: [0.7415403858528589, -0.968942616715629],
    type: ObjectiveType.DISCOVER,
}

export const IWentISawIConqueredPartOne: task = {
    name: "I went, I saw, I conquered - Part 1",
    ...
    objectives: [
        IWentISawIConquered_Objective1
    ],
    vendor: Handshake,
    level: 0,
}